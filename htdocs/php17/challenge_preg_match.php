<?php
// 西暦
$regexp_year   = '/[0-9]{1,4}/'; // 西暦の正規表現を入力
$check_year[0] = '1953';
$check_year[1] = '2013';
// 電話番号
$regexp_phone_number   = '/^[0-9]{2,4}-[0-9]{2,4}-[0-9]{3,4}/$'; // 電話番号の正規表現を入力
...
// メールアドレス
$regexp_mail   = '/^[a-zA-Z0-9_.+-]+[@][a-zA-Z0-9.]+$/'; // メールアドレスの正規表現を入力
$check_mail[0] = 'test@test.com';
$check_mail[1] = 'test_2@test.co.jp';
$check_mail[2] = 'test.3@example.ne.jp';
// URL
$regexp_url   = '/^(https?/ftp)(://[-_.!~*()a-zA-Z0-9;/?:@&amp;amp;=+$,%#]+)$'; // URLの正規表現を入力
