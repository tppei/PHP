        ...
        // 在庫数変更
                ...
                if(isset($_POST["change_status"])){
                    ...
                    $update_drinkid = $_POST['drink_id'];
                             ...
                             // 文字化け防止
                            mysqli_set_charset($link, 'utf8');
                            $query = "UPDATE drink_details SET 公開ステータス = '$poststatus' WHERE ドリンクID = $update_drinkid";
                            if(mysqli_query($link,$query) !== TRUE){
                                $err_msg[] = 'アップデート失敗'; 
                            };
            ...
            <table>
                ...
                ?>'>
                    <form method = 'post'>
                        ...
                        <td><input type="text" class="input_text_width text_align_right" name="update_stock" value='<?php print htmlspecialchars($go['在庫数'], ENT_QUOTES, 'UTF-8') ?>'>
                            <br>個
